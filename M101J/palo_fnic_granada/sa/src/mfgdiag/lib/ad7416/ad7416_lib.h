...
extern int  ad7416_rd (int fd, uint16_t i2c_addr, uint8_t offset, uint16_t *data);
extern int  ad7416_wr (int fd, uint16_t i2c_addr, uint8_t offset, uint16_t *data);
...
extern int8_t ad7416_temp_get (int fd, uint16_t i2c_addr);
