...
static adm1066_trim_t trim_ast[] = {
    ...
    {FEXT_ADM1066_I2C_ADDR, ADM1066_DAC_CODE_DAC6},
    {0xFF, 0x00},
    {0xFF, 0x00},
    {0xFF, 0x00},
    {0xFF, 0x00},
...
static adm1066_mon_t monitor_ast[] = {
    ...
    {FEXT_ADM1066_I2C_ADDR, ADM1066_ADC_RD_BACK_ADCHVP3, 8, 35, 2048, 0xffff,
     3300,  3300}, //V3V3 VP3
    {FEXT_ADM1066_I2C_ADDR, ADM1066_ADC_RD_BACK_ADCHVP4, 11, 24, 2048, 0xffff, 
     2500,  2500}, //V2V5 VP4
    {FEXT_ADM1066_I2C_ADDR, ADM1066_ADC_RD_BACK_ADCHVX1, 1, 2,  2048, 0xffff,
     1800,  1800}, //V1V8 VX1
    {FEXT_ADM1066_I2C_ADDR, ADM1066_ADC_RD_BACK_ADCHVX3, 1, 1,  2048, 0xffff,
     1100,  1100}, //V1V1 VX3
    {FEXT_ADM1066_I2C_ADDR, ADM1066_ADC_RD_BACK_ADCHVX2, 1, 1,  2048, 0xffff,
     1200,  1200}, //V1V2 VX2
    {FEXT_ADM1066_I2C_ADDR, ADM1066_ADC_RD_BACK_ADCHVH,  2, 21, 2048, 0xffff,
     12000, 12000}, //V12V0 VH
};

adm1066_channel_t channels_ast[] = {
    { "V1V0",  &trim_ast[0], 	&monitor_ast[0] },
    { "V3V3",  &trim_ast[1], 	&monitor_ast[1] },
    { "V2V5",  &trim_ast[2], 	&monitor_ast[2] },
    { "V1V8",  &trim_ast[3], 	&monitor_ast[3] },
    { "V1V1",  &trim_ast[4], 	&monitor_ast[4] },
    { "V1V2",  &trim_ast[5], 	&monitor_ast[5] },
    { "V12V0", NULL, 		&monitor_ast[6] },
};

int adm1066_channels_get(adm1066_channel_t **channels)
{
	*channels = channels_ast;
	return (sizeof(channels_ast)/sizeof(adm1066_channel_t));
}
...
static int adm1066_init_adc_ast (int fd, uint16_t i2c_addr)
{
        int     cnt, count, rc = 0;
        uint8_t data;
        // Write
...
int adm1066_init (int fd, uint16_t i2c_addr)
{
	...
	sleep(1);
	rc = adm1066_init_adc_ast (fd, i2c_addr);
	if (rc) {
		printf("Error: adm1066_init_adc_ast failed. i2c=0x%X, rc=%d\n",
			i2c_addr, rc);
		return (rc);
	}
	sleep(1);
